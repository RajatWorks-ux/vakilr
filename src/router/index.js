...
const routes = [
  ...
  { path: '/lawyer/services', name: 'LawyerServices', component: () => import('@/views/lawyer/LawyerServices.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
  ...
  { path: '/lawyer/schedule', name: 'LawyerSchedule', component: () => import('@/views/lawyer/LawyerSchedule.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
  { path: '/lawyer/requests', name: 'LawyerRequests', component: () => import('@/views/lawyer/LawyerRequests.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
  { path: '/lawyer/session/:id', name: 'LawyerSession', component: () => import('@/views/lawyer/LawyerSession.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
  { path: '/lawyer/wallet', name: 'LawyerWallet', component: () => import('@/views/lawyer/LawyerWallet.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
  { path: '/lawyer/reviews', name: 'LawyerReviews', component: () => import('@/views/lawyer/LawyerReviews.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
  { path: '/lawyer/cases', name: 'LawyerCases', component: () => import('@/views/lawyer/LawyerCases.vue'), meta: { requiresAuth: true, role: 'lawyer' } },
...
router.beforeEach((to, _from, next) => {
  ...
  // Role-based guard — skip for routes with no specific role (e.g. /admin/disputes)
